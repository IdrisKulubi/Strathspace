export default function Loading() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-br from-pink-400 via-purple-400 to-yellow-300 dark:from-purple-900 dark:via-pink-800 dark:to-yellow-600 animate-gradient-x relative overflow-hidden">
